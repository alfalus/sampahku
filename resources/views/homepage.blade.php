      ...
      >
        ...
        >
          ...
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            /
            <li class="flex items-center">
              <button class="text-white active:text-gray-100 text-xs font-bold">
                <i class="fas">Register</i>
              </button>
            </li>
          </ul>
        </div>
    ...
    <main>
      ...
      >
        <div
          ...
          style='background-image: url("https://images.unsplash.com/photo-1562077981-4d7eafd44932?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80");'
        >
          <span
            id="blackOverlay"
